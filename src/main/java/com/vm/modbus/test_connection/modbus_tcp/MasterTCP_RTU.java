...
public class MasterTCP_RTU {
    ...
    public static void main(String[] args) throws Exception{
        ...
        final ModbusMasterTcpModel modbusMasterTcpTest =
                new ModbusMasterTcpModel("localhost", 2222, 500, 1);
        ...
        final ModbusLocator test = new ModbusLocator(1, RegisterRange.HOLDING_REGISTER, 0, DataType.TWO_BYTE_INT_UNSIGNED);
...
//                    modbusLocator23);
            ...
            modbusInteger.readDataFromModBus(modbusMasterTcpTest, 1 , batchRead, false,
                    test);
